  ...
  return (
    <div className="fixed inset-0 z-[80]">
      ...
      <div className="absolute bottom-0 left-0 right-0 mx-auto w-full max-w-md"
        ...
        <div className="rounded-t-[2.5rem] px-5 pt-4 pb-6 shadow-2xl" style={{ background: "#0d0d0f", borderTop: "1px solid rgba(255,255,255,0.1)" }}>
          <div className="mx-auto mb-4 h-1 w-12 rounded-full" style={{ background: "rgba(255,255,255,0.12)" }} />
          ...
          {/* Súly bevitel */}
          <div className="mb-4">
            <div className="text-[9px] font-black tracking-widest mb-2" style={{ color: "rgba(255,255,255,0.3)" }}>CÉLSÚLY (kg)</div>
            <div className="flex gap-2 items-center">
              ...
              <input value={inputVal} inputMode="decimal"
                ...
                style={{ background: "rgba(255,255,255,0.05)", color: "var(--accent-primary)" }} />
          ...
          {/* Rúd kiválasztás */}
          <div className="mb-5">
            <div className="text-[9px] font-black tracking-widest mb-2" style={{ color: "rgba(255,255,255,0.3)" }}>RÚD SÚLYA</div>
          ...
          <div className="rounded-2xl p-4 mb-4" style={{ background: "rgba(255,255,255,0.04)" }}>
            <div className="text-[9px] font-black tracking-widest mb-3" style={{ color: "rgba(255,255,255,0.3)" }}>
              ÖSSZERAKÁS — EGY OLDAL
            </div>
            {plates.length === 0 ? (
              <div className="text-sm text-center py-2" style={{ color: "rgba(255,255,255,0.25)" }}>
                Csak rúd ({barKg} kg)
              </div>
            ) : (
              <>
                ...
                <div className="flex items-center gap-1.5 mb-3 overflow-x-auto pb-1">
                  ...
                  <div className="h-2 w-4 rounded-full shrink-0" style={{ background: "rgba(255,255,255,0.2)" }} />
                  {/* Plates */}
          ...
          <div className="flex items-center justify-between rounded-2xl px-4 py-3"
            ...
            <div>
              <div className="text-[10px]" style={{ color: "rgba(255,255,255,0.4)" }}>Tényleges súly</div>
